...
if (!import.meta.env.VITE_PUBLIC_NETWORK) throw new Error('NETWORK env var not set')
...
const dAppDefinitionAddress = import.meta.env.VITE_PUBLIC_DAPP_DEFINITION_ADDRESS
...
console.log("finished loading config.ts");
